...
werden zwar in zweidimensionalen Tabellen gespeichert und kˆnnen mit
einem Prim‰rschl¸ssel versehen werden. Es ist aber keine Definition
eines Fremdschl¸ssels mˆglich. Der Benutzer ist somit bei einer
MySQL-Datenbank vˆllig allein f¸r die (referenzielle) Integrit‰t der
...
ermˆglicht. Diese Projekte sind aber getrennt von MySQL zu betrachten.
...
Ten pakiet zawiera definicje kodowaÒ znakÛw potrzebne dla serwera i
klienta.
